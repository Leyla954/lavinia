  ...
  return (
    <section className='h-[550px]  w-full bg-[82%] bg-contain object-cover bg-no-repeat bg-[url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTgbyfm9UVPfjptSGHeTF4_gz9ItC67DS8inz3gm9WdCTQOJQ_ow2qFkSI-JXcwdlzgNE&usqp=CAU)]'>
      <div className='flex flex-col items-center'>
        ...
        <form action="" className='flex flex-col gap-1 p-7 px-11 w-[550px] h-[565px] rounded-md bg-green-800'>
          ...
          <input type="emai" className='p-2 rounded-md' placeholder='Please enter your email' />
          ...
          <label htmlFor="password" className='text-green-600 font-bold'>Confirm password</label>
          <input type="password" className='p-2 rounded-md' placeholder='Please enter try again your password' />
